...
public class AddAccountBookView extends javax.swing.JPanel {
    ...
    private boolean checkNumberBook() {
    ...
    public AddAccountBookView(AdminHome principalJFrame) {
    ...
    private void lbNumberBookMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_lbNumberBookMouseClicked
        ...
        while (true) {
            ...
            AccountBook existingBook = NEW_REQUEST_BOOK.getBookById(Integer.parseInt(newNumberBook));

            if (existingBook == null) {
                lbNumberBook.setText(newNumberBook);
                NumberBookChanged = true;
                break;
            } else {
                JPaneMessage.messageDialog(this,
    ...
    private void BtnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSaveActionPerformed
        ...
        if (checkTitleBook() && checkNumberBook() && checkBookRecords()) {
            try {
